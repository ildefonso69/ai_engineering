...
# (`estimator/app/domain/graph/agents/`). It is the single source of truth for
...
# `.env` defaults of each knob in `estimator/app/config.py` — these graph knobs
...
module Agents
  class GraphFlow
    ...
    # mirrors the graph-side text in estimator/app/domain/graph/personas.py and always
